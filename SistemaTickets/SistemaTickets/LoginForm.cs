...
namespace SistemaTickets.Presentation
{
    public partial class LoginForm : Form
    {
        ...
        private void GuardarConfiguracion()
        {
            ...
            {
                // Guardar email (implementación simplificada)
            }
        }
            ...
            try
            {
                ...
                if (usuario != null)
                {
                  ...
                  // Mostrar mensaje de bienvenida según rol
                    ...
                    {
                        case "HelpDesk":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre} - Primer Nivel de Soporte";
                            break;
                        case "SegundaLinea":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre} - Segundo Nivel de Soporte";
                            break;
                        case "InvestigacionDesarrollo":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre} - Área de I+D";
                            break;
                        case "Administrador":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre} - Administrador del Sistema";
                            break;
                        default:

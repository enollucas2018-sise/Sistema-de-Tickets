...
namespace SistemaTickets.Presentation
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeCustomComponent()
        {
            ...
            // Configurar eventos después de crear los controles
            ConfigurarEventosMenu(subMenuNuevoTicket, subMenuVerTickets, subMenuMisTickets,
                                subMenuBuscarTicket, subMenuReporteTickets, subMenuMetricas,
        ...
        private void ConfigurarInterfazSegunRol()
        {
            ...
            // Personalizar título según rol
            this.Text = $"Sistema de Tickets - {_usuarioLogueado.Nombre} ({_usuarioLogueado.Rol})";
        }
        ...
        private void ActualizarBarraEstado()
        {
            ...
            {
                statusBar.Items[0].Text = $"Usuario: {_usuarioLogueado.Nombre}";
        ...
        private void MostrarBienvenida()
        {
            ...
            lblTituloPrincipal.Text = $"BIENVENIDO/A {_usuarioLogueado.Nombre.ToUpper()}\nSISTEMA DE TICKETS - {_usuarioLogueado.Rol.ToUpper()}";
        ...
        {
            MessageBox.Show("Funcionalidad: Crear Nuevo Ticket\n(Formulario en desarrollo)",
                          "Nuevo Ticket", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        {
            MessageBox.Show("Funcionalidad: Lista de Tickets\n(Formulario en desarrollo)",
                          "Lista de Tickets", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        private void AbrirMisTickets()
        {
            MessageBox.Show("Funcionalidad: Mis Tickets Asignados\n(Formulario en desarrollo)",
                          "Mis Tickets", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

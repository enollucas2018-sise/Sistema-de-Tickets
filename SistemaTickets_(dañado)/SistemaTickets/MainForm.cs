...
namespace SistemaTickets.Presentation
{
    public partial class MainForm : Form
    {
        ...
        private void InitializeCustomComponent()
        {
            ...
            // Título principal (solo se muestra cuando no hay formulario activo)
                                         ...
                                         ToolStripButton btnReportes)
        {
            ...
            // Evento del menú Área de Conocimiento
        ...
        private void ConfigurarInterfazSegunRol()
        {
            ...
            this.Text = $"Sistema de Tickets - {_usuarioLogueado.Rol}";
        }
        ...
        private void MostrarBienvenida()
        {
            ...
            {
                case "HelpDesk":
                    mensajeRol = "PRIMER NIVEL DE SOPORTE";
                    break;
                case "SegundaLinea":
                    mensajeRol = "SEGUNDO NIVEL DE SOPORTE";
                    break;
                case "InvestigacionDesarrollo":
                    mensajeRol = "INVESTIGACIÓN Y DESARROLLO";
                    break;
                case "Administrador":
                    mensajeRol = "ADMINISTRADOR DEL SISTEMA";
                    break;
                default:
                    mensajeRol = _usuarioLogueado.Rol.ToUpper();
                    break;
            }

            lblTituloPrincipal.Text = $"SISTEMA DE TICKETS\n{mensajeRol}";
        ...
        // ========== NUEVO MÉTODO: SALIR DEL SISTEMA ==========

            ...
            try
            {
                ...
                if (usuario != null)
                {
                  ...
                  // Mostrar mensaje de bienvenida según rol
                    ...
                    {
                        case "HelpDesk":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre_Usuario} - Helpdesk";
                            break;
                        case "SegundaLinea":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre_Usuario} - Segunda Línea";
                            break;
                        case "InvestigacionDesarrollo":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre_Usuario} - Área de R & D";
                            break;
                        case "Administrador":
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre_Usuario} - Administrador del Sistema";
                            break;
                        default:
                            mensajeBienvenida = $"Bienvenido/a {usuario.Nombre_Usuario}";
                            break;
                    }
